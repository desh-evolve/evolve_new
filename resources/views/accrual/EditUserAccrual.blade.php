                    ...
                    <form method="POST"
                        ...
                        <table class="table table-bordered">
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="text" name="data[amount]" value="{{$data['amount']}}"> {{$current_user_prefs->getTimeUnitFormatExample()}}
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="date" id="time_stamp" name="data[time_stamp]" value="{{$data['time_stamp']}}">
