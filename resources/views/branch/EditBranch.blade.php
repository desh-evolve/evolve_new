    ...
    <div class="center-container">
        <div class="card w-50"> <!-- Adjust width as needed -->
            <div class="card-header align-items-center d-flex justify-content-between">
                <h4 class="card-title mb-0 flex-grow-1">Branch {{ isset($data['id']) ? 'Edit' : 'Add' }}</h4>
            ...
            <div class="card-body">
                ...
                <form method="POST"
                    action="{{ isset($data['id']) ? route('branch.save', $data['id']) : route('branch.save') }}">
                    @csrf
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="branch_short_id" id="branch_short_id" class="form-control"
                            value="{{ $data['branch_short_id'] ?? '' }}">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="fax_phone" id="fax_phone" class="form-control"
                            value="{{ $data['fax_phone'] ?? '' }}">
                    </div>

                    <div class="form-group">
                        <label for="business_reg_no">Business Registration No</label>
                        <input type="text" name="business_reg_no" id="business_reg_no" class="form-control"
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="etf_no" id="etf_no" class="form-control"
                            value="{{ $data['etf_no'] ?? '' }}">
                    </div>

                    @if (isset($data['other_field_names']['other_id1']))
                        <div class="form-group">
                            <label for="other_id1">{{ $data['other_field_names']['other_id1'] }}</label>
                            <input type="text" name="other_id1" id="other_id1" class="form-control"
                                value="{{ $data['other_id1'] ?? '' }}">
                        </div>
                    @endif

                    @if (isset($data['other_field_names']['other_id2']))
                        <div class="form-group">
                            <label for="other_id2">{{ $data['other_field_names']['other_id2'] }}</label>
                            <input type="text" name="other_id2" id="other_id2" class="form-control"
                                value="{{ $data['other_id2'] ?? '' }}">
                        </div>
                    @endif

                    @if (isset($data['other_field_names']['other_id3']))
                        <div class="form-group">
                            <label for="other_id3">{{ $data['other_field_names']['other_id3'] }}</label>
                            <input type="text" name="other_id3" id="other_id3" class="form-control"
                                value="{{ $data['other_id3'] ?? '' }}">
                        </div>
                    @endif

                    @if (isset($data['other_field_names']['other_id4']))
                        <div class="form-group">
                            <label for="other_id4">{{ $data['other_field_names']['other_id4'] }}</label>
                            <input type="text" name="other_id4" id="other_id4" class="form-control"
                                value="{{ $data['other_id4'] ?? '' }}">
                        </div>
                    @endif

                    @if (isset($data['other_field_names']['other_id5']))
                        <div class="form-group">
                            <label for="other_id5">{{ $data['other_field_names']['other_id5'] }}</label>
                            <input type="text" name="other_id5" id="other_id5" class="form-control"
                                value="{{ $data['other_id5'] ?? '' }}">
                        </div>
                    @endif
