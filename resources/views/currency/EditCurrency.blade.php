    ...
    <div class="center-container">
        <div class="card w-50"> <!-- Adjust width as needed -->
            <div class="card-header align-items-center d-flex justify-content-between">
                ...
                <a href="/currency" class="btn btn-primary">Currencies List <i class="ri-arrow-right-line"></i></a>
            </div>
            ...
            <div class="card-body">
                ...
                <form method="POST"
                    action="{{ isset($data['id']) ? route('currency.save', $data['id']) : route('currency.save') }}">
                    @csrf
