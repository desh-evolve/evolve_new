                                ...
                                <tr class="">
                                    ...
                                    <td>
                                        @if ($row['calculation_id'] == "20")
                                            <a href="javascript:ImportCsvFile('{{$row['name']}}','{{$row['id']}}');"><img src="{$IMAGES_URL}/nav_popup.gif" alt="" style="vertical-align: middle" /></a>
                                        @endif					
                                    </td>
                            ...
                            <tr>
                                <td class="tblActionRow" colspan="8">             
                                    @if ($permission->Check('company_tax_deduction','add'))
                                        <input type="submit" class="button" name="action" value="Add Presets" onClick="return confirmSubmit('Are you sure you want to add all presets based on your company location?')">
