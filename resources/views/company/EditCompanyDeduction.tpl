		...
		<form method="post" name="wage" action="{$smarty.server.SCRIPT_NAME}">
		    <div id="contentBoxTwoEdit">
				...
				<tr>
					...
					<td class="cellRightEditTable">
						<input type="radio"  name="data[basis_of_employment]" value="1"  {if $data.basis_of_employment =="1"}  checked="checked"  {/if}> {t}Contract{/t} <br />
                                                <input type="radio"  name="data[basis_of_employment]" value="2"  {if $data.basis_of_employment =="2"}  checked="checked"  {/if}> {t}Permanent{/t} <br />
                                                <input type="radio"  name="data[basis_of_employment]" value="3"  {if $data.basis_of_employment =="3"}  checked="checked"  {/if}> {t}All{/t} <br />
					</td>
				</tr>
