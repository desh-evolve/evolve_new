...
<table class="table table-bordered" id="schedule_table" height="100%">
	<form method="get" target="day_schedule" name="schedule" action="/schedule/view_schedule_day">
        ...
        @foreach ($calendar_array as $calendar)
                ...
                <tr class="bg-primary text-white">
					...
					@if ($total_users > 1)
                        <td width="30%" rowspan="100" valign="middle" height="100%">
                            <iframe style="width:0; height:100%; border: 5px" id="day_schedule" name="day_schedule" src="blank.html"></iframe>
                        </td>
                    @endif
				</tr>
            @endif
            ...
            @if ($total_users <= 1)
                <td 
                    ...
                    id="cursor-hand" onClick="TIMETREX.schedule.editSchedule('','',{{$calendar['epoch']}})"
                    @endif
                    class="
                    ...
                    valign="top">
                    @if ($calendar['day_of_month'] != NULL)
                        <table class="table table-bordered" border="0" cellpadding="0" cellspacing="2" width="100%">
                            <tr>
                                        ...
                                        <tr>
                                            <td colspan="2" align="center" nowrap>
                                                ...
                                                @if($shifts['status_id'] == 20)
                                                    <p color="red">{{$shifts['absence_policy'] ?? "N/A"}}</p>
                                                @else
...
<script>
    changeHeight(
        ...
        parent.document.getElementById('schedule_layer'),
        'screen_size'
    );
