		    ...
		    <div id="contentBoxTwoEdit">
				...
				<tr>
					<td class="{isvalid object="ppsf" label="user" value="cellLeftEditTable"}" nowrap>
						<b>{t}Subordinates:{/t}</b><a href="javascript:toggleRowObject('filter_employees_on');toggleRowObject('filter_employees_off');filterUserCount();"><i class="ri-arrow-down-double-fill arrow-icon" style="vertical-align: middle" ></i></a>
					</td>
					<td colspan="3">
						<table class="editTable">
						<tr class="tblHeader">
