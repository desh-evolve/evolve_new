...
<!--FL ADDED STATIC DATAS-->
                                ...
                                <tr>
                                    ...
                                    <td class="cellRightEditTable"> 
                                        <select name="filter_data[pay_mode]">
                                ...
                                <tr>
                                        ...
                                        <td colspan="2" class="cellRightEditTable">
                                                ...
                                                <img src="{$BASE_URL}/images/cal.gif" id="cal_date_payments " width="16" height="16" border="0" alt="Pick a date" onMouseOver="calendar_setup('date_payments', 'cal_date_payments', false);">
                                                {t}ie:{/t} {$current_user_prefs->getDateFormatExample()}
                                        </td>
                                </tr> 
                                ...
                                <tr>
                                    ...
                                    <td class="cellRightEditTable"> 
                                          <input type="text" size="10" id="date_payments" name="filter_data[district_office]" value=" ">
                                              
                                    </td> 
				</tr>
<!--END FL ADDED STATIC DATAS-->
...
END -->                
				...
				<tr>
					...
					<td class="cellRightEditTable"> 
                                            <input type="checkbox" name="filter_data[submission_number]" value="submission_num" >
					</td>
