        ...
        <div class="col-lg-8">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form method="POST"
                        action="{{ isset($data['id']) ? route('policy.break_policies.submit', $data['id']) : route('policy.break_policies.submit') }}">
                        @csrf
                        ...
                        <div class="form-group">
                            <label for="auto_detect_type">Auto-Detect Breaks By</label>
                            <select 
                        ...
                        <div id="include_break_punch_time" style="display:none">
                            <div class="form-group">
                                <label for="window_length">Include Any Punched Time for Break</label>
                                <input
                                    type="checkbox" 
                                    class="checkbox"
                                    name="data[include_break_punch_time]" 
                                    value="1" {{(!empty($data['include_break_punch_time']) AND $data['include_break_punch_time'] == TRUE) && 'checked' }}
                                />
                            </div>
                            <div class="form-group">
                                <label for="window_length">Include Multiple Breaks</label>
                                <input
                                    type="checkbox" 
                                    class="checkbox"
                                    name="data[include_multiple_breaks]" 
                                    value="1" {{(!empty($data['include_multiple_breaks']) AND $data['include_multiple_breaks'] == TRUE) && 'checked' }}
                                />
                            </div>
