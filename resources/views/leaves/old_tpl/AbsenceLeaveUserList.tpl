		...
		<form method="get" action="{$smarty.server.SCRIPT_NAME}">
				...
				<tr class="tblHeader">
					...
					<td>
						...
						{include file="column_sort.tpl" label=$label sort_column="year" current_column="$sort_column" current_order="$sort_order"}
					</td>
					...
					<tr class="{$row_class}">
						...
						<td>
							...
							{if $permission->Check('company_tax_deduction','edit')}
								[ <a href="{urlbuilder script="EditAbsenceLeaveUser.php" values="id=$row_id" merge="FALSE"}">{t}Edit{/t}</a> ]
