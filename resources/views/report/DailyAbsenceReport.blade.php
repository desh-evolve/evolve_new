        ...
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form method="post" name="report" action="{{ route('report.daily_Absence_report') }}" target="_self">
                        @csrf
                        ...
                        <div id="contentBoxTwoEdit">
                            ...
                            <table class="table table-bordered">
                                ...
                                <tr>
                                    <td class="cellReportRadioColumn" rowspan="1">
                                ...
                                <tr hidden>
                                    ...
                                    <td class="cellRightEditTable">
                                        <input type="text" size="15" id="end_date" name="filter_data[end_date]"
