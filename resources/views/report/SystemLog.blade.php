    ...
    <div class="d-flex justify-content-center">
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="post" name="report" action="{{ route('report.audit_trail_report') }}" target="_self">
                        @csrf
                        ...
                        <div id="contentBoxTwoEdit">
                            ...
                            <table class="table table-bordered">
                                ...
                                {!! html_report_filter([
                                    ...
                                    'label' => 'log_action',
                                    'display_name' => 'Action',
                                    'display_plural_name' => 'Actions',
                                ]) !!}

                                {!! html_report_filter([
                                    'filter_data' => $filter_data,
                                    'label' => 'log_table_name',
                                    'display_name' => 'Object',
                                    'display_plural_name' => 'Objects',
                                ]) !!}
