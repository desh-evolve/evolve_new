    ...
    <div class="d-flex justify-content-center">
        <div class="col-lg-12">
            <div class="card">
                ...
                <form method="post" name="report" action="{{ route('report.employee_time_overtime_report_monthly') }}" target="_self">
                        @csrf
                        ...
                        <div id="contentBoxTwoEdit">
                            ...
                            <table class="table table-bordered">
                                ...
                                <tr onclick="showHelpEntry('sort')">
                                    {{-- <td colspan="2" class="text-end {{ isvalid(['object' => 'uwf', 'label' => 'type', 'value' => 'cellLeftEditTableHeader']) }}"> --}}
                                    <td colspan="2" >
                                        {{ __('Export Format:') }}
                                    </td>
                        ...
                        {{-- <div id="contentBoxFour" class="mt-3">
                            <button type="submit" class="btn btn-primary btn-sm {{ $hidden_elements['displayReport'] ?? '' }}" name="BUTTON" value="{{ __('Display Report') }}" onclick="selectAllReportCriteria(); this.form.target = '_self'; document.getElementById('action').value = 'Display Report';">
                                {{ __('Display Report') }}
                            </button>
                            <button type="submit" class="btn btn-primary btn-sm {{ $hidden_elements['displayTimeSheet'] ?? '' }}" name="BUTTON" value="{{ __('Display TimeSheet') }}" onclick="selectAllReportCriteria(); document.getElementById('action').value = 'Display TimeSheet';">
                                {{ __('Display TimeSheet') }}
                            </button>
                            <button type="submit" class="btn btn-primary btn-sm {{ $hidden_elements['displayDetailedTimeSheet'] ?? '' }}" name="BUTTON" value="{{ __('Display Detailed TimeSheet') }}" onclick="selectAllReportCriteria(); document.getElementById('action').value = 'Display Detailed TimeSheet';">
                                {{ __('Display Detailed TimeSheet') }}
                            </button>
                            <button type="submit" class="btn btn-primary btn-sm {{ $hidden_elements['export'] ?? '' }}" name="BUTTON" value="{{ __('Export') }}" onclick="selectAllReportCriteria(); this.form.target = '_self'; document.getElementById('action').value = 'Export';">
                                {{ __('Export') }}
                            </button>
                        </div> --}}
                        ...
                        <div id="contentBoxFour" class="mt-3">
                            ...
                            <button type="button"
                                ...
                                onclick="selectAllReportCriteria(); this.form.target = '_blank'; document.getElementById('action').value = 'Display TimeSheet'; this.form.submit();">
                                {{ __('Display TimeSheet') }}
                            </button>
                            <button type="button"
                                class="btn btn-primary btn-sm {{ $hidden_elements['displayDetailedTimeSheet'] }}"
                                id="display_detailed_timesheet"
                                onclick="selectAllReportCriteria(); this.form.target = '_blank'; document.getElementById('action').value = 'Display Detailed TimeSheet'; this.form.submit();">
                                {{ __('Display Detailed TimeSheet') }}
                            </button>
                            <button type="button"
