...
<div id="rowContentInner">
		<form method="post" name="report" action="{$smarty.server.SCRIPT_NAME}" target="_self">
		    ...
		    <div id="contentBoxTwoEdit">
				...
				<tr>
					<td class="cellReportRadioColumn" rowspan="0">
					...
					<td class="cellRightEditTable">
                                            <input type="text" size="15" id="start_date" name="filter_data[start_date]" onchange="setEndDatejs()" value="{getdate type="DATE" epoch=$filter_data.start_date}">
