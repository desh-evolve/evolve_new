    ...
    <div class="d-flex justify-content-center">
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="post" name="report" action="{{ route('report.missing_punch_report') }}" target="_self">
                        @csrf
                            ...
                            <table class="table table-bordered">
                                ...
                                {{-- <tr>
                                    <td class="cellReportRadioColumn" rowspan="2">
                                        <input type="radio" class="checkbox" id="date_type_date" name="filter_data[date_type]" value="date" onclick="showReportDateType();" {{ $filter_data['date_type'] == '' || $filter_data['date_type'] == 'date' ? 'checked' : '' }}>
                                    </td>

                                    <td class="cellReportRadioColumn" rowspan="2">
                                        <input type="radio" class="checkbox" id="date_type_date" name="filter_data[date_type]" value="date" onclick="showReportDateType();" 
                                        {{ isset($filter_data['date_type']) && ($filter_data['date_type'] == '' || $filter_data['date_type'] == 'date') ? 'checked' : '' }}>
                                    </td>
                                    ...
                                    <td class="cellRightEditTable">
                                        <div class="input-group">
                                            <input type="text" size="15" id="start_date" name="filter_data[start_date]" value="{{ getdate(['type' => 'DATE', 'epoch' => $filter_data['start_date']]) }}" class="form-control">
                                            <span class="input-group-text">
                                                <img src="{{ $BASE_URL }}/images/cal.gif" id="cal_start_date" width="16" height="16" border="0" alt="{{ __('Pick a date') }}" onmouseover="calendar_setup('start_date', 'cal_start_date', false);">
                                            </span>
                                        </div>
                                ...
                                <tr>
                                    ...
                                    <td class="cellRightEditTable">
                                        <div class="input-group">
                                            <input type="text" size="15" id="end_date" name="filter_data[end_date]" value="{{ getdate(['type' => 'DATE', 'epoch' => $filter_data['end_date']]) }}" class="form-control">
                                            <span class="input-group-text">
                                                <img src="{{ $BASE_URL }}/images/cal.gif" id="cal_end_date" width="16" height="16" border="0" alt="{{ __('Pick a date') }}" onmouseover="calendar_setup('end_date', 'cal_end_date', false);">
                                            </span>
                                        </div>
                                        {{ __('ie:') }} {{ $current_user_prefs->getDateFormatExample() }}
                                    </td>
