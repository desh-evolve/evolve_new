...
<!-- ARSP EDIT - I HIDE THIS CODE START
				...
				<input type="submit" name="BUTTON" value="{t}View Pay Stub{/t}" onClick="selectAllReportCriteria(); this.form.target = '_self'; document.getElementById('action').name = 'action:View Pay Stubs';this.form.submit()">
