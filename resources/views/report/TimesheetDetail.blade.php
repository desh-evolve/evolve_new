    ...
    <div class="d-flex justify-content-center">
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="post" name="report" action="{{ route('report.employee_timesheet_report') }}"   target="_self">
                        @csrf
                            ...
                            <table class="table table-bordered">
                                ...
                                <tr>
                                    ...
                                    <td class="cellRightEditTable">
                                        <input type="text" id="start_date" name="filter_data[start_date]"
                                ...
                                <tr>
                                    ...
                                    <td class="cellRightEditTable">
                                        <input type="text" id="end_date" name="filter_data[end_date]"
                                            value="{{ getdate_helper('DATE', $filter_data['end_date'] ?? '') }}">
                                        <img src="{{ $BASE_URL }}/images/cal.gif" id="cal_end_date" width="16"
                                            height="16" border="0" alt="{{ __('Pick a date') }}"
                                            onmouseover="calendar_setup('end_date', 'cal_end_date', false);">
                                        {{ __('ie:') }} {{ $current_user_prefs->getDateFormatExample() }}
                                    </td>
                                </tr>
                        ...
                        <div id="contentBoxFour" class="mt-3">
                            ...
                            {{-- <button type="button"
                                ...
                                id="export"
                                onclick="selectAllReportCriteria(); this.form.target = '_blank'; document.getElementById('action').value = 'Export'; this.form.submit();">
                                {{ __('Export') }}
                            </button> --}}

                            {{-- <button type="submit"
                                class="btn btn-primary btn-sm {{ $hidden_elements['displayReport'] ?? '' }}"
                                name="BUTTON" value="{{ __('Display Report') }}"
                                onclick="selectAllReportCriteria(); this.form.target = '_self'; document.getElementById('action').name = 'action:Display Report';">
                                {{ __('Display Report') }}
                            </button> --}}
                            </button>
                        </div>
