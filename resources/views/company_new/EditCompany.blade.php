                    ...
                    <form method="POST" id="company_form" enctype="multipart/form-data">
                        ...
                        <div class="px-4 py-2">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-9">
                                    <input type="text" class="form-control w-50" id="name" placeholder="Enter Company Full Name" value="">
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-9">
                                    <input type="text" class="form-control w-50" id="short_name" placeholder="Enter Company Short Name" value="">
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-9">
                                    <input type="text" class="form-control w-50" id="short_name" placeholder="Enter Business / Employer Identification Number" value="">
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-9">
                                    <input type="text" class="form-control w-50" id="address1" placeholder="Enter Address" value="">
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-9">
                                    <input type="text" class="form-control w-50" id="address_2" placeholder="Enter Address" value="">
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-9">
                                    <input type="text" class="form-control w-50" id="postal_code" placeholder="Enter Postal Code" value="">
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-9">
                                    <input type="text" class="form-control w-50" id="work_phone" placeholder="Enter Phone No" value="">
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-9">
                                    <input type="text" class="form-control w-50" id="fax_phone" placeholder="Enter Fax No" value="">
                                </div>
                            </div>

                            <div class="row mb-3">
                                <label for="business_number" class="form-label req mb-1 col-md-3">Business Number</label>
                                <div class="col-md-9">
                                    <input type="text" class="form-control w-50" id="business_number" placeholder="Enter Business No" value="">
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-9">
                                    <input type="text" class="form-control w-50" id="epf_number" placeholder="Enter EPF Reg No" value="">
                                </div>
                            </div>
