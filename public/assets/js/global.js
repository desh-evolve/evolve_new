...
function confirmSubmit(text) {
	...
	if ( text == null ) {
		text = "You are about to delete data, once data is deleted it can not be recovered.\nAre you sure you wish to continue?";
	}
...
function SubmitWithMessage(form) {
		var alertMsg= "Frame data DOES NOT exists:";
...
function newMailPopUp(base_url) {
		var resultMsg = "You have new mail waiting. Would you like to read it now?";
...
function isModifiedForm() {
	var msg = "You have modified data without saving, if you press OK you will lose any changes you have made!";
