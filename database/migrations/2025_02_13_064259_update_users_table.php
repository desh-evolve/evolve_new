...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        Schema::create('users', function (Blueprint $table) {
            ...
            $table->timestamp('rf_id_updated_date')->nullable();
            $table->timestamp('finger_print_1_updated_date')->nullable();
            $table->timestamp('finger_print_2_updated_date')->nullable();
            $table->timestamp('finger_print_3_updated_date')->nullable();
            $table->timestamp('finger_print_4_updated_date')->nullable();
