...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        Schema::create('users', function (Blueprint $table) {
            ...
            $table->integer('password_reset_date')->nullable();
            ...
            $table->integer('resign_date')->nullable();
            ...
            $table->integer('rf_id_updated_date')->nullable();
            $table->integer('finger_print_1_updated_date')->nullable();
            $table->integer('finger_print_2_updated_date')->nullable();
            $table->integer('finger_print_3_updated_date')->nullable();
            $table->integer('finger_print_4_updated_date')->nullable();
