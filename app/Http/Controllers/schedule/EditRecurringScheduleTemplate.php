...
class EditRecurringScheduleTemplate extends Controller
{
    ...
    public function index(Request $request)
    {
		...
		$viewData['title'] = 'Recurring Schedule Template';
        ...
        $week_rows  = $request->input('week_rows', []);
        ...
        switch ($action) {
            ...
            default:
                ...
                //var_dump($week_rows);
                $viewData['data'] = $data;
		        $viewData['week_rows'] = $week_rows;

                break;
        }

        $viewData['rstcf'] = $rstcf;
		$viewData['rstf'] = $rstf;
        // dd($viewData);

		return view('schedule/EditRecurringScheduleTemplate', $viewData);
    }
