...
$smarty->assign('title', __($title = 'Lieu Leave And Duty to Lieu Leave Report')); // See index.php
...
*/
		...
		$filter_data['sort_direction_options'] = Misc::getSortDirectionArray();
                ...
                $filter_data['export_type_options'] = Misc::prependArray( array( 'pdfMonthlyDetailLate' => _('Lieu Leave and Duty to Lieu Leave Report')) );
