...
$smarty->assign('title', __($title = 'Monthly Attendance Report')); // See index.php
...
*/
        ...
        $filter_data['export_type_options'] = Misc::prependArray( array(  'pdfMonthlyDetailAttendance' => __('Monthly Attendance Report')) );
