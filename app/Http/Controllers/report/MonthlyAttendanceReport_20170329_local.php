...
$smarty->assign('title', TTi18n::gettext($title = 'Monthly Attendance Report')); // See index.php
...
*/
        ...
        $filter_data['export_type_options'] = Misc::prependArray( array(  'pdfMonthlyDetailAttendance' => TTi18n::gettext('Monthly Attendance Report')) );
...
*/
		...
		$smarty->display('report/MonthlyAttendanceReport.tpl');
