...
$static_columns = array(
							'-0800-epf_membership_no' => __('EPF  #'),
							'-0801-full_name' => __('Full Name'),
							'-0802-basic_for_epf' => __('Basic for EPF'),
							...
							'-1132-epf_20_persent' => __('E.P.F - 20%'),
							);
...
//                                                                var_dump($tmp_rows); die;
                                                                $tmp_rows[$x]['basic_for_epf'] = number_format(doubleval($tmp_rows[$x][1]) + doubleval($tmp_rows[$x][49]) + doubleval($tmp_rows[$x][7]) - doubleval($tmp_rows[$x][45]),2,'.','');
...
//												$pseal_obj->getTotalEmployerDeduction() );
		...
		$filter_data['export_type_options'] = Misc::prependArray( array( 'csv' => __('CSV (Excel)'), 'pdfp' => __('PDF (PORTRAIT)'), 'pdfl' => __('PDF (LANDSCAPE)'), 'formc' => __('Form C (PDF)'), 'payslip3' => __('3 Payslip/Page (PDF)'), 'payslip4' => __('4 Payslip/Page (Landscape PDF)')), Misc::trimSortPrefix( $psf->getOptions('export_type') ) );
		//$filter_data['export_type_options'] = Misc::prependArray( array( 'csv' => __('CSV (Excel)') ), Misc::trimSortPrefix( $psf->getOptions('export_type') ) );
