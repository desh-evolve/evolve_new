...
$smarty->assign('title', TTi18n::gettext($title = 'Monthly Late Attendance Report')); // See index.php
...
*/
		...
		$filter_data['sort_direction_options'] = Misc::getSortDirectionArray();
                ...
                $filter_data['export_type_options'] = Misc::prependArray( array( 'pdfMonthlyDetailLate' => TTi18n::gettext('Monthly Late Report')) );
