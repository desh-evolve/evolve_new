		...
		if ( $action == 'display_timesheet' ) {
			if ( isset($rows) ) {
				...
				foreach( $rows as $user_data ) {
					...
					$pdf->SetFont('','B',32);
					$pdf->Cell(200,15, _('Employee Time Card') , $border, 0, 'C');
					$pdf->Ln();
					$pdf->SetFont('','B',12);
					...
					$pdf->Ln();
                                        ...
                                        $pdf->SetFont('','',12);
					$pdf->Cell(140,5, _('Pay Period:') , $border, 0, 'R');
					$pdf->SetFont('','',12);
...
$pdf->Ln();
								...
								$pdf->MultiCell( $column_widths['min_punch_time_stamp'], $line_h, _('In') , 1, 'C', 1, 0);
								$pdf->MultiCell( $column_widths['max_punch_time_stamp'], $line_h, _('Out') , 1, 'C', 1, 0);
