...
$smarty->assign('title', TTi18n::gettext($title = 'Head Count & Absence Report')); // See index.php
...
*/
        ...
        $filter_data['export_type_options'] = Misc::prependArray( array(  'pdfDailyAbsence' => TTi18n::gettext('Daily Absence')) );
