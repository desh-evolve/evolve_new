...
//                                exit();
			...
			if ( isset($rows) && $filter_data['include_user_ids']) {    
				...
				Debug::Text('Exporting as Form C PDF', __FILE__, __LINE__, __METHOD__,10);
                                ...
                                $pslf = TTnew( 'PayStubListFactory' );//new code                                
                                $output = $pslf->Form_ETF($rows, $filter_data['include_user_ids'], $current_user, $current_company, $payperiod_string, $branch_id_only,$filter_data['export_type'],$filter_data['submission_number']);//new code    
