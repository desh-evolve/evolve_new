...
//                                echo '<pre>';   print_r($rows); echo '<pre>'; die;
                            ...
                            {
                                echo _('Invalid Payperiod Group!! Please Select JANUARY - JUNE or JULY - DECEMBER Months Group of Same Year Pay Periods.') ."<br>\n";        
                            }                            
                        }else {
                        ...
                        echo _('Pleasae Select Six months Pay Period. JANUARY - JUNE or JULY - DECMBER ') ."<br>\n"; 
                        }                    
                }  				
	...
	default:
		...
		$filter_data['export_type_options'] = Misc::prependArray( array('formcsixmonth' => _('PDF')) ); //ARSP EDIT --> I HIDE THIS CODE ", Misc::trimSortPrefix( $psf->getOptions('export_type') )"  .IT'S USE TO HIDE THE ALL OTHER EXPORT OPTIONS  	
