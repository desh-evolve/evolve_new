...
$smarty->assign('title', TTi18n::gettext($title = 'Late Attendance And Early Departures')); // See index.php
...
*/
		...
		$filter_data['sort_direction_options'] = Misc::getSortDirectionArray();
                ...
                $filter_data['export_type_options'] = Misc::prependArray( array(  'pdfDailyLate' => TTi18n::gettext('Daily Attendance / Late')) );
