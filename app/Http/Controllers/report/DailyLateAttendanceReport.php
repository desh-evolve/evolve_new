...
$smarty->assign('title', ___($title = 'Late Attendance And Early Departures')); // See index.php
...
//                                
                                ...
                                if ( Debug::getVerbosity() < 11 ) {                                    
                                  //  Misc::FileDownloadHeader('DailyLateReport.pdf', 'application/pdf', strlen($output));
                                    Misc::FileDownloadHeader('LateAttendanceAndEarlyDepartureReport.pdf', 'application/pdf', strlen($output));
                                    echo $output;
                                    exit;                           
                                } 
...
*/
		...
		$filter_data['sort_direction_options'] = Misc::getSortDirectionArray();
                ...
                $filter_data['export_type_options'] = Misc::prependArray( array(  'pdfDailyLate' => __('Daily Attendance / Late')) );
...
*/
		...
		$smarty->display('report/DailyLateAttendanceReport.tpl');
