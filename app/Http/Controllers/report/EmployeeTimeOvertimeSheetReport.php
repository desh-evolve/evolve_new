...
$smarty->assign('title', TTi18n::gettext($title = 'Employee Overtime  Report')); // See index.php
...
//                                 echo '<pre>'; print_r($rows[0]['data']); echo '<pre>';  die;
                            ...
                            //FL ADDED FOR GET TIME SHEET AND OVERTIME REPORT 20160518
                            if( $filter_data['export_type'] == 'mothlyTimesheet'){
                                //echo '<pre>'; print_r($rows); echo '<pre>';  //die;
                                 Debug::Text('Exporting as PDF', __FILE__, __LINE__, __METHOD__,10);
                                 
                                $tssr= new TimesheetDetailReport();//new code                                
                                $output = $tssr->EmployeeOverTimeSheet($rows, $filter_columns, $filter_data, $current_user, $current_company);//new code 
...
*/
		...
		$filter_data['sort_direction_options'] = Misc::getSortDirectionArray();
                ...
                $filter_data['export_type_options'] = Misc::prependArray( array( 'mothlyTimesheet' => TTi18n::gettext('Employee OT Sheet')) );
