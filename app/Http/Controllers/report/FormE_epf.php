...
$smarty->assign('title', TTi18n::gettext($title = 'Contribution Details - E Report'));  // See index.php
...
//                                echo '<pre>'; print_r($rows); echo '<pre>';  die;
                                $pslf = TTnew( 'PayStubListFactory' );//new code                                
                                $output = $pslf->FormE_epf($rows, $filter_data['include_user_ids'], $current_user, $current_company, $payperiod_string, $branch_id_only,$filter_data['export_type'],$filter_data['submission_number']);//new code    
	...
	default:
		...
		$smarty->display('report/FormE_epf.tpl');
