...
$smarty->assign('title', __($title = 'Over Time Report Monthly'));  // See index.php
...
//                               echo '<pre>'; print_r($filter_data); echo '<pre>'; die;
	...
	default:
		...
		/***/
                ...
                $filter_data['export_type_options'] = Misc::prependArray( array( 'pdfOTreport' => __('Monthly OT Report')) );
//                $filter_data['export_type_options'] = Misc::prependArray( array( 'csv' => __('CSV (Excel)'), 'pdfp' => __('PDF (PORTRAIT)'), 'pdfOTreport' => __('Monthly OT Report')) );
