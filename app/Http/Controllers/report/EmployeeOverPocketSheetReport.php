...
*/
		...
		$ulf->getSearchByCompanyIdAndArrayCriteriaForOP( $current_company->getId(), $filter_data );
...
//                                 echo '<pre>'; print_r($rows[0]['data']); echo '<pre>';  die;
                            ...
                            if( $filter_data['export_type'] == 'mothlyOPsheet'){
                                //echo '<pre>'; print_r($rows); echo '<pre>';  //die;
                                 Debug::Text('Exporting as PDF', __FILE__, __LINE__, __METHOD__,10);
                                
                                $tssr= new TimesheetDetailReport();//new code                                
                                $output = $tssr->EmployeeOverPocketSheet($rows, $filter_columns, $filter_data, $current_user, $current_company);//new code 
...
*/
		...
		$filter_data['sort_direction_options'] = Misc::getSortDirectionArray();
                ...
                $filter_data['export_type_options'] = Misc::prependArray( array( 'mothlyOPsheet' => TTi18n::gettext('Employee OP Sheet')) );
