				...
				exit;
                           ...
                           if (isset($rows) AND isset($filter_columns)) {
                               ...
                               $export_filter_columns = array(
                                   ...
                                   'emp_9' => _('Short Leave'), 
                                   'emp_10' => _('NoPay'), 
                                   'emp_11' => _('Late Attendance'),
                                   'emp_12' => _('Early Departure'), 
                                   'emp_13' => _('OT'), 
                                   'emp_14' => _(' '), 
                                   'emp_15' => _(' '),
                                   'emp_16' => _(' '), 
...
*/
		...
		$filter_data['sort_direction_options'] = Misc::getSortDirectionArray();
                ...
                $filter_data['export_type_options'] = Misc::prependArray( array(  'pdfMonthlyDetailAttendance' => _('Monthly Attendance Report'),'excelMonthlyDetailAttendance' => _('Monthly Attendance Report Excel')) );
                //$filter_data['export_type_options'] = Misc::prependArray( array(  'excelMonthlyDetailAttendance' => _('Monthly Attendance Report Excel')) ); 
