...
$smarty->assign('title', __($title = 'Monthly Attendance Per User')); // See index.php
				...
				exit;
                           ...
                           if (isset($rows) AND isset($filter_columns)) {
                               ...
                               $export_filter_columns = array(
                                   ...
                                   'emp_7' => __('Present'), 
                                   'emp_8' => __('Leaves'), 
                                   'emp_9' => __('Short Leave'), 
                                   'emp_10' => __('NoPay'), 
                                   'emp_11' => __('Late Attendance'),
                                   'emp_12' => __('Early Departure'), 
                                   'emp_13' => __('OT'), 
                                   'emp_14' => __(' '), 
                                   'emp_15' => __(' '),
                                   'emp_16' => __(' '), 
...
*/
		...
		$filter_data['sort_direction_options'] = Misc::getSortDirectionArray();
                ...
                $filter_data['export_type_options'] = Misc::prependArray( array(  'pdfMonthlyDetailAttendance' => __('Monthly Attendance Report'),'excelMonthlyDetailAttendance' => __('Monthly Attendance Report Excel')) );
                //$filter_data['export_type_options'] = Misc::prependArray( array(  'excelMonthlyDetailAttendance' => __('Monthly Attendance Report Excel')) ); 
