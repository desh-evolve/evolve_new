...
$quarter_options = array(
						1 => __('Quarter 1 (01-Jan to 31-Mar)'),
						2 => __('Quarter 2 (01-Apr to 30-Jun)'),
						3 => __('Quarter 3 (01-Jul to 30-Sep)'),
						4 => __('Quarter 4 (01-Oct to 31-Dec)'),
						);
...
switch ($action) {
	...
	default:
		...
		$filter_data['deposit_schedule_options'] = array( 10 => __('Monthly'), 20 => __('Semi-Weekly') );
