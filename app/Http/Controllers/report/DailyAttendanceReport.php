...
$smarty->assign('title', __($title = 'Daily Attendance Report')); // See index.php
...
*/
		...
		$filter_data['sort_direction_options'] = Misc::getSortDirectionArray();
                ...
                $filter_data['export_type_options'] = Misc::prependArray( array(  'pdfDailyDetailAttendance' => _('Daily Attendance Report')) );
