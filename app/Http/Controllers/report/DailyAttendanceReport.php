...
$smarty->assign('title', TTi18n::gettext($title = 'Daily Attendance Report')); // See index.php
...
$filter_data['end_date'] = isset($filter_data['start_date']) ? $filter_data['start_date'] : [];
...
//                                 echo '<pre>'; print_r($rows[0]); echo '<pre>';  die;
                                ...
                                $output = $tsdr->DailyAttendanceDetailed($rows, $filter_columns, $filter_data, $current_user, $current_company);//new code                               
...
*/
		...
		$filter_data['sort_direction_options'] = Misc::getSortDirectionArray();
                ...
                $filter_data['export_type_options'] = Misc::prependArray( array(  'pdfDailyDetailAttendance' => TTi18n::gettext('Daily Attendance Report')) );
...
*/
		...
		$smarty->display('report/DailyAttendanceReport.tpl');
