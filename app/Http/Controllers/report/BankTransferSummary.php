...
//                                exit();
			...
			if ( isset($rows) && $filter_data['include_user_ids']) {    
				...
				Debug::Text('Exporting as Total Organization Pay Summary PDF', __FILE__, __LINE__, __METHOD__,10);
                                ...
                                echo __('Pleasae Select at Least One Pay Period.') ."<br>\n";                                    
                                }
                }  				
*/									
...
//                                $output = $pslft->testfunction();//new code                                     
	...
	default:
		...
		//$filter_data['export_type_options'] =  Misc::prependArray( array('formc' => __('Form C (PDF)')) ); //ARSP EDIT --> I HIDE THIS CODE ", Misc::trimSortPrefix( $psf->getOptions('export_type') )"  .IT'S USE TO HIDE THE ALL OTHER EXPORT OPTIONS  	
                $filter_data['export_type_options'] = Misc::prependArray( array('bank_transfer' => __('Bank Transfer Summary (PDF)'),'csv' => __('Export CVS (Excel)')) ); //ARSP EDIT --> I HIDE THIS CODE ", Misc::trimSortPrefix( $psf->getOptions('export_type') )"  .IT'S USE TO HIDE THE ALL OTHER EXPORT OPTIONS              
