...
$non_static_columns = array(		'-1100-income' => __('Income (14)'),
									'-1110-income_tax' => __('Income Tax (22)'),
									'-1120-employee_cpp' => __('Employee CPP (16)'),
									'-1125-ei_earnings' => __('EI Insurable Earnings (24)'),
									'-1126-cpp_earnings' => __('CPP Pensionable Earnings (26)'),
									'-1130-employee_ei' => __('Employee EI (18)'),
									'-1140-union_dues' => __('Union Dues (44)'),
									'-1150-employer_cpp' => __('Employer CPP'),
									'-1160-employer_ei' => __('Employer EI'),
									'-1170-rpp' => __('RPP Contributions (20)'),
									'-1180-charity' => __('Charity Donations (46)'),
									'-1190-pension_adjustment' => __('Pension Adjustment (52)'),
									'-1200-other_box_0' => __('Other Box 1'),
									'-1210-other_box_1' => __('Other Box 2'),
									'-1220-other_box_2' => __('Other Box 3'),
									'-1220-other_box_3' => __('Other Box 4'),
									'-1220-other_box_4' => __('Other Box 5'),
									'-1220-other_box_5' => __('Other Box 6'),
									);
	...
	case 'export':
		...
		if ( isset($rows) AND ( $action == 'display_t4s' OR $action == 'export_xml' ) ) {
			...
			if ( Debug::getVerbosity() == 11 ) {
				...
				echo __('Invalid data, unable to generate report.');
				Debug::writeToLog();
				exit;
			}
		} else {
