...
//                                exit();
	...
	default:
		...
		//$filter_data['export_type_options'] = Misc::prependArray( array('formc' => _('Form C (PDF)')) ); //ARSP EDIT --> I HIDE THIS CODE ", Misc::trimSortPrefix( $psf->getOptions('export_type') )"  .IT'S USE TO HIDE THE ALL OTHER EXPORT OPTIONS  	
                $filter_data['export_type_options'] = Misc::prependArray( array('total_organization_pay' => _('Total Organization Pay Summary (PDF)')) ); //ARSP EDIT --> I HIDE THIS CODE ", Misc::trimSortPrefix( $psf->getOptions('export_type') )"  .IT'S USE TO HIDE THE ALL OTHER EXPORT OPTIONS              
