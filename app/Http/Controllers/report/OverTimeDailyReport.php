...
$smarty->assign('title', TTi18n::gettext($title = 'Daily Over Time Report')); // See index.php
...
//                                 echo '<pre>'; print_r($rows[0]['data']); echo '<pre>';  die;
                               ...
                               // print_r($rows);
                                ...
                                if ( Debug::getVerbosity() < 11 ) {                                    
                                    Misc::FileDownloadHeader('DailyOverTimeReport.pdf', 'application/pdf', strlen($output));
                                    echo $output;
                                    exit;                           
                                }
...
*/
		...
		$filter_data['sort_direction_options'] = Misc::getSortDirectionArray();
                ...
                $filter_data['export_type_options'] = Misc::prependArray( array( 'pdfOTDetails' => TTi18n::gettext('OT Daily Monthly Report')) );
...
*/
		...
		$smarty->display('report/OverTimeDailyReport.tpl');
