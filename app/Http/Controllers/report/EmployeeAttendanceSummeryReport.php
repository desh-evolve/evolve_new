...
$smarty->assign('title', TTi18n::gettext($title = 'Employee Attendance Summery')); // See index.php
...
*/
		...
		$filter_data['sort_direction_options'] = Misc::getSortDirectionArray();
                ...
                $filter_data['export_type_options'] = Misc::prependArray( array(  'pdfDepartmentDetailAttendance' => TTi18n::gettext('Epmloyee Attendance Summerry Report'),'employeeattendancesummeryexcel' => TTi18n::gettext('Epmloyee Attendance Summerry Excel Report')) );
