...
$smarty->assign('title', __($title = 'Employee Attendance Summery')); // See index.php
...
$columns = array(
    ...
    '-1090-worked_time' => __('Worked Timezzzz'),
...
;
		 ...
		 if ($action == 'display_report'){
                     ...
                     if($filter_data['export_type']==='pdfDepartmentDetailAttendance'){
                         
                        Debug::Text('Exporting as PDF', __FILE__, __LINE__, __METHOD__,10);
                                
                                $tsdr= new TimesheetDetailReport();//new code         
                               
                                $output = $tsdr->EmployeeAttendanceSummery($rows, $filter_columns, $filter_data, $current_user, $current_company);//new code                               
                      ...
                      elseif($filter_data['export_type']==='employeeattendancesummeryexcel'){
                          
                          $tsdr= new TimesheetDetailReport();//new code
                          
                          $tsdr->EmployeeAttendanceSummeryExcel($rows, $filter_columns, $filter_data, $current_user, $current_company);
                      }
			...
			$smarty->display('report/EmployeeAttendanceSummeryReport.tpl');
		}
...
*/
		...
		$filter_data['sort_direction_options'] = Misc::getSortDirectionArray();
                ...
                $filter_data['export_type_options'] = Misc::prependArray( array(  'pdfDepartmentDetailAttendance' => __('Epmloyee Attendance Summerry Report'),'employeeattendancesummeryexcel' => __('Epmloyee Attendance Summerry Excel Report')) );
//                $filter_data['export_type_options'] = Misc::prependArray( array(  'pdfMonthlyDetailAttendance' => __('Monthly Attendance Report'),'csv' => __('CSV (Excel)')) );
