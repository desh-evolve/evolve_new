...
$columns = array(
    ...
    '-1090-worked_time' => _('Worked Timezzzz'),
...
*/
		...
		$filter_data['sort_direction_options'] = Misc::getSortDirectionArray();
                ...
                $filter_data['export_type_options'] = Misc::prependArray( array(  'pdfDepartmentDetailAttendance' => _('Epmloyee Attendance Summerry Report'),'employeeattendancesummeryexcel' => _('Epmloyee Attendance Summerry Excel Report')) );
//                $filter_data['export_type_options'] = Misc::prependArray( array(  'pdfMonthlyDetailAttendance' => _('Monthly Attendance Report'),'csv' => _('CSV (Excel)')) );
