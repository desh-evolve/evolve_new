...
switch ($action) {
	...
	//echo '<pre>'; print_r($pc_data); 
	unset($pc_data);
	//echo '<br>-----------<br>';print_r($pc_data);die;
...
array
(
    'time_stamp' => '1489456380',
    'date_stamp' => '1489429800',
    'repeat' => '0',
    'type_id' => '10',
    'status_id' => '10',
    'branch_id' => '10',
    ...
    'user_id' => '621',
    'user_date_id' => '', 
    'punch_full_time_stamp' => '1489456380'
),

array
(
    'time_stamp' => '1489491300',
    'date_stamp' => '1489429800',
    'repeat' => '0',
    'type_id' => '10',
    'status_id' => '20',
    ...
    'user_id' => '621',
    'user_date_id' => '',
    'punch_full_time_stamp' => '1489491300'
),
array
(
    'time_stamp' => '1489542780',
    'date_stamp' => '1489516200',
    'repeat' => '0',
    'type_id' => '10',
    'status_id' => '10',
    'branch_id' => '10',
    ...
    'user_id' => '621',
    'user_date_id' => '',
    'punch_full_time_stamp' => '1489542780',
)

);
foreach($data_set as $key => $pc_data)
{
...
//}die;
	...
	echo '<br>key...'.$key;print_r($pc_data);
		...
		if ( isset($pc_data) ) {
                if ( $pc_data['date_stamp'] != '' AND $pc_data['time_stamp'] != '') {
                        //$punch_full_time_stamp = TTDate::parseDateTime($pc_data['date_stamp'].' '.$pc_data['time_stamp']);
                		$punch_full_time_stamp = $pc_data['time_stamp'];
                        $pc_data['punch_full_time_stamp'] = $punch_full_time_stamp;
                        $pc_data['time_stamp'] = $punch_full_time_stamp;
                } else {
                        $pc_data['punch_full_time_stamp'] = NULL;
