...
/*
 * $Revision: 4870 $
 * $Id: UserGenericDataListFactory.class.php 4870 2011-06-22 22:52:17Z ipso $
 * $Date: 2011-06-22 15:52:17 -0700 (Wed, 22 Jun 2011) $
 */
	...
	*/
	...
	function getAPISearchByCompanyIdAndArrayCriteria( $company_id, $filter_data, $limit = NULL, $page = NULL, $where = NULL, $order = NULL ) {
		...
		if ( isset($filter_data['name']) AND isset($filter_data['name'][0]) AND !in_array(-1, (array)$filter_data['name']) ) {
			$query  .=	' AND lower( a.name ) in ('. $this->getListSQL( array_map('strtolower', $filter_data['name']), $ph) .') ';
		}
