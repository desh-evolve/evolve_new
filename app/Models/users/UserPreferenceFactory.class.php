...
/*
 * $Revision: 5523 $
 * $Id: UserPreferenceFactory.class.php 5523 2011-11-16 00:54:14Z ipso $
 * $Date: 2011-11-15 16:54:14 -0800 (Tue, 15 Nov 2011) $
 */
...
//											'd/M/Y' 	=> '25/Feb/2001 (dd/mmm/yyyy)',
			...
			case 'area_code_timezone':
				...
				$retval = array(
									...
									306	=> array('country' => 'CA', 'province' => 'SK', 'time_zone' => 'CST'), ///-7*	 Canada: Saskatchewan
									...
									480	=> array('country' => 'US', 'province' => 'AZ', 'time_zone' => 'MST7MDT'), //*	 Arizona: East Phoenix (see 520; also Phoenix split 602, 623)
									520	=> array('country' => 'US', 'province' => 'AZ', 'time_zone' => 'MST7MDT'), //*	 SE Arizona: Tucson area (split from 602; see split 928)
									602	=> array('country' => 'US', 'province' => 'AZ', 'time_zone' => 'MST7MDT'), //*	 Arizona: Phoenix (see 520; also Phoenix split 480, 623)
									623	=> array('country' => 'US', 'province' => 'AZ', 'time_zone' => 'MST7MDT'), //*	 Arizona: West Phoenix (see 520; also Phoenix split 480, 602)
									928	=> array('country' => 'US', 'province' => 'AZ', 'time_zone' => 'MST7MDT'), //*	 Central and Northern Arizona: Prescott, Flagstaff, Yuma (split from 520)
	...
	function getLocationTimeZone( $country, $province, $work_phone = FALSE, $home_phone = FALSE, $default = FALSE ) {
		...
		if ( $work_phone != '' ) {
			...
			if ( $work_area_code !== FALSE AND isset($area_code_timezone[$work_area_code]) AND $area_code_timezone[$work_area_code]['time_zone'] != NULL ) {
		...
		if ( $home_phone != '' ) {
			...
			if ( $home_area_code !== FALSE AND isset($area_code_timezone[$home_area_code]) AND $area_code_timezone[$home_area_code]['time_zone'] != NULL) {
