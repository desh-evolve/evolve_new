...
class UserDateUpdateFormListFactory extends UserDateUpdateFormFactory implements IteratorAggregate {
	...
	function getByUserId($id, $where = NULL, $order = NULL) {
		...
		if ( $order == NULL ) {
//			$order = array( 'b.first_worked_date' => 'desc');//ARSP NOTE --> I MODIFIED THIS CODE FOR THUNDER & NEON
			$strict = FALSE;
		} else {
			$strict = TRUE;
		}
