...
class PayStubBankTransfer extends TTPDF{
	...
	$this->setXY( Misc::AdjustXY(85, 0), Misc::AdjustXY(0, -15) );
        ...
        $this->Cell(0, 10, TTi18n::gettext('Bank Transfer Details Generated By').' '. APPLICATION_NAME, 0, false, 'L', 0, '', 0, false, 'T', 'M');
    ...
    public function Header() {
		...
		$this->Cell(185, 5, TTi18n::gettext('Bank Transfer Details'), $border, 0, 'C', 0);
		...
		$this->setLineWidth( 1 );     
                ...
                //table position
                $this->setXY( Misc::AdjustXY(0, $adjust_x), Misc::AdjustXY(33, $adjust_y) );
                $this->SetFont('times','B',9);  

                $html = '<table border="1" width="108%" cellspacing="0" cellpadding= "2">
                            <tr style ="background-color:#CCCCCC;">
                                <th width="4%" height="23"><div align="center" >#</div></th>
                                <th width="8%" ><div align="center">Bank Code</div></th>
                                <th width="18%"><div align="center">Bank Name</div></th>
                                <th ><div align="center" >Bank Branch</div></th>
                                <th width="13%"><div align="center">Bank Account No</div></th>
                                <th width="6%" ><div align="center">EPF No</div></th>                                
                                <th width="20%"><div align="center">Name</div></th>
                                <th width="10%"><div align="center">Total Pay</div></th>     
                            </tr>
                            </table>';        
