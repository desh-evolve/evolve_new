...
//                    $regular_salary = $row1['1']; //in this case $row['1'] is a regular time earning value
                    $regular_salary = number_format(doubleval($row1[1]) + doubleval($row1[49]) + doubleval($row1[77]) + doubleval($row1[7]) - doubleval($row1[45]),2,'.',''); //in this case $row['1'] is a regular time earning value
...
//                    $regular_salary = $row['1']; //in this case $row['1'] is a regular time earning value
                    $regular_salary = number_format(doubleval($row[1]) + doubleval($row[49]) + doubleval($row[77]) + doubleval($row[7]) - doubleval($row[45]),2,'.',''); //in this case $row['1'] is a regular time earning value
                    $user_obj = $ulf->getById( $user_id )->getCurrent();//get user object  
