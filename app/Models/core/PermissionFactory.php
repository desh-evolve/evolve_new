			...
			case 'name':
				$retval = array(
											...
											'user' => 	array(
																...
																'medical_aid_scheme' => TTi18n::gettext('Medical Aid Scheme'),//FL ADDED FOR NATONAL PVC 20160627
																'personal_date_update_form' => TTi18n::gettext('Personal Date Update Form'),//FL ADDED FOR NATONAL PVC 20160627
																'employee_excel_upload' => TTi18n::gettext('Employee List Excel Upload'),//FL ADDED FOR NATONAL PVC 20160627
																//'undelete' => TTi18n::gettext('Un-Delete')
															),
											...
											'schedule' => 	array(
																...
																'add_rosters' => TTi18n::gettext('Add Rosters'),//FL ADDED
															),
											'other_field' => 	array(
																'enabled' => TTi18n::gettext('Enabled'),
																'view_own' => TTi18n::gettext('View Own'),
											...
											'report' => 		array(
																...
																'view_leave_summary' => TTi18n::gettext('Leaves Summary'),
																'view_accrual_balance_summary' => TTi18n::gettext('Accrual Balance Summary'),
																'view_leave_summary' => TTi18n::gettext('Leave Balance Summary'),//FL ADDED FOR NATONAL PVC 20160816
																'view_schedule_summary' => TTi18n::gettext('Schedule Summary'),
                                                                'cform_reports' => TTi18n::gettext('C Forms Reports'),//FL ADDED 20160201H
                                                                'mail_pay_slip' => TTi18n::gettext('Mail Payslips'),//FL ADDED 20160201H
                                                               'tot_org_summary' => TTi18n::gettext('Total Organization Summary'),//FL ADDED 20160201H
                                                               'cform_reports_new' => TTi18n::gettext('C Forms Reports New'),//FL ADDED 20160201H
