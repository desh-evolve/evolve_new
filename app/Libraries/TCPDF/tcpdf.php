...
if (!defined("K_PATH_CACHE")) {
    // Only define this if Laravel's base_path() function is available
    if (function_exists('base_path')) {
        define("K_PATH_CACHE", base_path() . "/storage/app/tcpdf_cache/");
    } else {
        // Fallback path or throw an error/log it
        define("K_PATH_CACHE", __DIR__ . "/../../../storage/app/tcpdf_cache/");
    }
}

require_once(base_path('app/Libraries/TCPDF/config/tcpdf_config.php'));
require_once(base_path('app/Libraries/TCPDF/unicode_data.php'));
require_once(base_path('app/Libraries/TCPDF/htmlcolors.php'));
